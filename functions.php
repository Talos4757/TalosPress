...
function generate_scripts() {
	...
	if ( ICL_LANGUAGE_CODE == "he" ) {
		wp_enqueue_style( 'generate-style', get_template_directory_uri() . '/css/RTL/rtl.css', false, GENERATE_VERSION, 'all' );
	}
	else {
	...
	if ( ICL_LANGUAGE_CODE == "he" ) {
		wp_enqueue_style( 'superfish-rtl', get_template_directory_uri() . '/css/RTL/superfish-rtl.css', false, GENERATE_VERSION, 'all' );
	}
	else {
...
function generate_add_footer_info() {
	?>
	<span
		class="copyright"><?php _e( 'Copyright', 'generate' );?> &copy; <?php echo date( 'Y' ); ?></span> <?php do_action( 'generate_copyright_line' );?>
<?php
}
...
function generate_dequeue_mobile_scripts() {
	...
	// Add necessary styles to kill mobile responsive features
