				...
				<div class="meta-box-sortables">
					<form method="post" action="options.php">
						...
						<div class="postbox generate-metabox" id="gen-1">
							...
							<div class="inside">
								<p>
									<strong
										style="display:inline-block;width:60px;"><?php _e( 'Version', 'generate' );?>
										:</strong> <?php echo GENERATE_VERSION; ?><br/>
									<strong style="display:inline-block;width:60px;"><?php _e( 'Author', 'generate' );?>
										:</strong> <a href="<?php echo esc_url( 'http://edge22.com' );?>"
									                  target="_blank">Thomas Usborne</a><br/>
									<strong
										style="display:inline-block;width:60px;"><?php _e( 'Website', 'generate' );?>
										:</strong> <a href="<?php echo esc_url( 'http://generatepress.com' );?>"
								...
								<p>
									<a id="generate_customize_button" class="button button-primary"
									   href="<?php echo admin_url( 'customize.php' ); ?>"><?php _e( 'Customizer', 'generate' );?></a>
									<?php if ( generate_addons_available() ) : ?>
										<a id="generate_addon_button" class="button button-primary"
										   href="<?php echo esc_url( 'http://generatepress.com/addons' ); ?>"
										   target="_blank"><?php _e( 'Add-ons', 'generate' ); ?></a>
									<?php endif; ?>
									<a title="<?php _e( 'Please help support development of the GeneratePress by buying me a coffee :)', 'generate' );?>"
									   class="button button-primary" target="_blank"
									   href="<?php echo esc_url( 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=UVPTY2ZJA68S6' );?>"><?php _e( 'Buy me a coffee :)', 'generate' );?></a>
								</p>
							</div>
						</div>
					...
					<div class="postbox generate-metabox" id="gen-delete">
						...
						<div class="inside">
							...
							<form method="post">
								<p><input type="hidden" name="generate_reset_customizer"
								          value="generate_reset_customizer_settings"/></p>
...
function generate_reset_customizer_settings() {
	...
	wp_safe_redirect( admin_url( 'admin.php?page=generate-options&status=reset' ) );
	exit;
